...
@foreach($products as $product)
    ...
    @if($product->name == "White Truffle")
        ...
        <div class="row justify-content-center align-items-center"> <!-- Product Description -->
            <div class="col-md-4">
                <img class="img-fluid" style="height: 30rem;" src="{{asset('storage/' .$product->image)}}" alt="">
            </div>
            <div class="col-md-4" style="z-index: 9999; top: 4rem;">
                <h4>PACKAGE OF 200G FOR €100</h4>
                {{--                <h4>SELECT SIZE</h4>--}}
                ...
                <div class="container-chevron" style="top: -5rem;">
