            ...
            <div class="container">
                <div class="row py-5">
                            ...
                            <li class="list-group-item d-flex justify-content-between lh-condensed">
                                ...
                                <div>
                                    @foreach(Cart::content() as $item)
                                        ...
                                        <h7 style="text-transform: uppercase; font-size: .7rem;">{{$item->qty}} <span
                                                style="font-size: .5rem">x</span> €<span>{{$item->model->price}}</span>
                                        </h7>
                    ...
                    <div class="col-md-8 order-md-1">
                        ...
                        <form class="needs-validation" id="payment-form" action="{{route('shop.checkout.store')}}"
                              method="POST">
                            {{csrf_field()}}
                            <div class="row">
